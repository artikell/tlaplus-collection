---- MODULE TwoPhase_TTrace_1751702693 ----
...
_inv ==
    ~(
        ...
        /\
        participantStates = ([P1 |-> "VOTED_NO", P2 |-> "VOTE_REQUEST"])
        /\
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("TwoPhase_TTrace_1751702693.json", _TETrace)
...
\*
\*trace == IODeserialize("TwoPhase_TTrace_1751702693.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([participantStates |-> [P1 |-> "VOTE_REQUEST", P2 |-> "VOTE_REQUEST"],votes |-> [P1 |-> FALSE, P2 |-> FALSE],coordinatorState |-> "VOTE_REQUEST",timestamp |-> 1]),
    ([participantStates |-> [P1 |-> "VOTED_NO", P2 |-> "VOTE_REQUEST"],votes |-> [P1 |-> TRUE, P2 |-> FALSE],coordinatorState |-> ,timestamp |-> 2])
    >>
----
...
---- CONFIG TwoPhase_TTrace_1751702693 ----
...
ALIAS
    _expression
=============================================================================
\* Generated on Sat Jul 05 16:04:54 CST 2025